...
A full-stack auction platform where users can create auctions and place bids in real time. Users can log in with Google SSO. Multiple auctions can run concurrently with many users bidding simultaneously.
